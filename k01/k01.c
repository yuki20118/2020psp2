...
printf("ave = %.2lf/n ",ave_n);
printf("var = %.2lf/n",var_n);
printf("ave_all = %.2lf±%.2lf/n",ave_n,gap);
printf("var_all = %.2lf/n",u2);
...
{
    double var_n;
    var_n=(((n-1)*pow(ave,2))/n + pow(val,2)/n) - pow(((n-1)*ave/n)+(val/n),2);
